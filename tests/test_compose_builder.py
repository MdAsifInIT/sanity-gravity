...
from compose import ComposeBuilder, ComposeService  # noqa: E402
...
def _load_cli():
    """Import sanity-cli (no .py extension) as a module for direct calls."""
    loader = importlib.machinery.SourceFileLoader(
        "sanity_cli_module", str(_REPO_ROOT / "sanity-cli")
    )
    spec = importlib.util.spec_from_loader("sanity_cli_module", loader)
